...
const navigation = [
	...
	{ name: 'Сертификати', href: '/certificates' },
	{ name: 'Услуги', href: '/services' },
];
export default function Header() {
	const [mobileMenuOpen, setMobileMenuOpen] = useState(false);
	return (
		<header className="sticky inset-x-0 top-0 z-50 bg-gray-300 bg-opacity-90">
			<nav
			...
			>
				...
				<div className="flex lg:hidden">
					...
					>
						...
						<Bars3Icon className="h-6 w-6 bg-purple-200" aria-hidden="true" />
					</button>
				</div>
				...
				<Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
					<div className="flex items-center justify-between">
						...
						>
							...
							<XMarkIcon className="h-6 w-6 bg-purple-200" aria-hidden="true" />
						</button>
					</div>
